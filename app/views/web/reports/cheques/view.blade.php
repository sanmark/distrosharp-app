		...
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<div class="form-group inline-form">
					...
					{{Form::select( 'rep', $reps, $repId,array('class' => 'form-control'), array('class' => 'form-control'))}}
				</div>  
				<div class="form-group inline-form">
					{{Form::label('route',null, array('class' => 'control-label'))}}
					{{Form::select('route',$routes,$route,array('class' => 'form-control'), array('class' => 'form-control'))}}
				</div> 
				<div class="form-group inline-form">
					{{Form::label('customer',null, array('class' => 'control-label'))}}
					{{Form::select('customer', $customers, $customerId,array('class' => 'form-control'), array('class' => 'form-control'))}}
				</div> 
				<div class="form-group inline-form">
					{{Form::label('bank',null, array('class' => 'control-label'))}}
					{{Form::select('bank', $banks, $bankId,array('class' => 'form-control'), array('class' => 'form-control'))}}
				</div> 
				<div class="form-group inline-form">
					{{Form::label('from',null, array('class' => 'control-label'))}} 
					{{Form::input('date', 'date_from', $date_from,array('class' => 'form-control'))}}
				</div>   
				<div class="form-group inline-form">
					{{Form::label('to',null, array('class' => 'control-label'))}} 
					{{Form::input('date', 'date_to', $date_to,array('class' => 'form-control'))}}
				</div>   
				<div class="form-group inline-form">
					{{Form::label('cheque_num',null, array('class' => 'control-label'))}} 
					{{Form::input('text', 'cheque_num', $cheque_num,array('class' => 'form-control'))}}
				</div>  
				<div class="form-group inline-form">
