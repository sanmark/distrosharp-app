...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				{{Form::input('number','current_buying_price', null, array('class' => 'form-control','required'=>true,'step'=>'any'))}}
			</div>
		</div>
		<div class="form-group">
			{{Form::label('current_selling_price', null, array('class' => 'col-sm-2 control-label'))}}
			<div class="col-sm-4">
				{{Form::input('number','current_selling_price', null, array('class' => 'form-control','required'=>true,'step'=>'any'))}}
			</div>
		</div>
		<div class="form-group">
			{{Form::label('buying_invoice_order', null, array('class' => 'col-sm-2 control-label'))}}
			<div class="col-sm-4">
				{{Form::input('number','buying_invoice_order', null, array('class' => 'form-control','required'=>true,'step'=>'any'))}}
			</div>
		</div>
		<div class="form-group">
			{{Form::label('selling_invoice_order', null, array('class' => 'col-sm-2 control-label'))}}
			<div class="col-sm-4">
				{{Form::input('number','selling_invoice_order', null, array('class' => 'form-control','required'=>true,'step'=>'any'))}}
			</div>
		</div>
		<div class="form-group">
