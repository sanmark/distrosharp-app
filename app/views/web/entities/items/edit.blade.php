...
<div class="panel panel-default well">
	...
	<div class="panel-body">
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				{{Form::input('number','current_buying_price', null, array('tabindex' => '4', 'class' => 'form-control','required'=>true,'step'=>'0.01'))}}
			</div>
		</div>
		<div class="form-group">
			{{Form::label('current_selling_price', null, array('class' => 'col-sm-2 control-label'))}}
			<div class="col-sm-4">
				{{Form::input('number','current_selling_price', null, array('tabindex' => '5', 'class' => 'form-control','required'=>true,'step'=>'0.01'))}}
			</div> 
		</div>
		<div class="form-group">
			{{Form::label('weight (g)', null, array('class' => 'col-sm-2 control-label'))}}
			<div class="col-sm-4">
				{{Form::input('number','weight', null, array('tabindex' => '7', 'class' => 'form-control','step'=>'0.01'))}}
			</div> 
		</div> 
		<div class="form-group">
